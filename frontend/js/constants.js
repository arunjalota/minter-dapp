const contractAddress = "0xC20Cd1b27bD9921265F1C83808A2ef91AF99Aa4D"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the The Dwarf Army NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The TDA NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection.';
